...
<body>
 ...
 <div class="d-flex flex-column flex-shrink-0 p-3 text-white bg-dark" style="width: 280px; height:730px">
    ...
    <ul class="nav nav-pills flex-column mb-auto">
      <li class="nav-item">
        <a href="#" id="addemp"  class="nav-link active" aria-current="page">
...
const ele = document.getElementById("maincontent")
const str = `  <form>
    <img class="mb-4" src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcRvt1G2-TQBfdANVf9c5TeL6cp9J37jkqIgmQ&usqp=CAU" alt="" width="72" height="57">
...
document.getElementById("addemp").addEventListner('click',()=>{
	ele.innerHtml = str;
})
